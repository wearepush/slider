...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(11)(IteratorPrototype, __webpack_require__(243)('iterator'), function () { return this; });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var has = __webpack_require__(24);
	var TAG = __webpack_require__(243)('toStringTag');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var hide = __webpack_require__(11);
	var Iterators = __webpack_require__(237);
	var TO_STRING_TAG = __webpack_require__(243)('toStringTag');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var setToStringTag = __webpack_require__(242);
	var uid = __webpack_require__(35);
	var wks = __webpack_require__(243);
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function (test, buggy, set) {
	      try {
	        set = __webpack_require__(9)(Function.call, __webpack_require__(259).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(6);
	// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
	$export($export.S, 'Object', { create: __webpack_require__(239) });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CustomizedRange = function (_React$Component) {
	  ...
	  CustomizedRange.prototype.render = function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('input', { type: 'number', value: this.state.lowerBound, onChange: this.onLowerBoundChange }),
	      ...
	      _react2.default.createElement('input', { type: 'number', value: this.state.upperBound, onChange: this.onUpperBoundChange }),
	      _react2.default.createElement('br', null),
	      _react2.default.createElement(
	        'button',
	      ...
	      _react2.default.createElement('br', null),
	      _react2.default.createElement('br', null),
	      _react2.default.createElement(Range, { allowCross: false, value: this.state.value, onChange: this.onSliderChange })
	    );
	  };
	...
	var DynamicBounds = function (_React$Component2) {
	  ...
	  DynamicBounds.prototype.render = function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('input', { type: 'number', value: this.state.min, onChange: this.onMinChange }),
	      _react2.default.createElement('br', null),
	      _react2.default.createElement(
	        'label',
	        null,
	      ...
	      _react2.default.createElement('input', { type: 'number', value: this.state.max, onChange: this.onMaxChange }),
	      _react2.default.createElement('br', null),
	      _react2.default.createElement('br', null),
	      _react2.default.createElement(Range, { defaultValue: [20, 50], min: this.state.min, max: this.state.max,
	...
	var ControlledRange = function (_React$Component3) {
	  ...
	  ControlledRange.prototype.render = function render() {
	    return _react2.default.createElement(Range, { value: this.state.value, onChange: this.handleChange });
	  };
	...
	var PureRenderRange = function (_React$Component4) {
	  (0, _inherits3.default)(PureRenderRange, _React$Component4);
	
	  function PureRenderRange(props) {
	    (0, _classCallCheck3.default)(this, PureRenderRange);
	  ...
	  PureRenderRange.prototype.render = function render() {
	    return _react2.default.createElement(Range, { defaultValue: [20, 40, 60, 80], onChange: this.handleChange, allowCross: false });
	  };
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(Range, { allowCross: false, defaultValue: [0, 20], onChange: log })
	  ),
	  _react2.default.createElement(
	    'div',
	    { style: style },
	    ...
	    _react2.default.createElement(Range, { step: 20, defaultValue: [20, 20], onBeforeChange: log })
	  ),
	  _react2.default.createElement(
	    'div',
	    { style: style },
	    ...
	    _react2.default.createElement(Range, { dots: true, step: 20, defaultValue: [20, 40], onAfterChange: log })
	  ),
	  _react2.default.createElement(
	    'div',
	    { style: style },
	    ...
	    _react2.default.createElement(Range, { allowCross: false, defaultValue: [0, 20], onChange: log, disabled: true })
	  ),
	  _react2.default.createElement(
	    'div',
	    { style: style },
	    ...
	    _react2.default.createElement(ControlledRange, null)
	  ),
	  _react2.default.createElement(
	    'div',
	    { style: style },
	    ...
	    _react2.default.createElement(Range, { count: 3, defaultValue: [20, 40, 60, 80], pushable: true })
	  ),
	  _react2.default.createElement(
	    'div',
	    { style: style },
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(CustomizedRange, null)
	  ),
	  _react2.default.createElement(
	    'div',
	    { style: style },
	    ...
	    _react2.default.createElement(DynamicBounds, null)
	  ),
	  _react2.default.createElement(
	    'div',
	    { style: style },
	    ...
	    _react2.default.createElement(PureRenderRange, null)
	  )
